        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-bit-title text-center">
                    <!-- Como o produto será enviado dinamicamente pela seleção do usuário, alteramos a rotina
                    estática da Sony SmartTV para os dados do objeto product 
                        ...
                        <div class="col-sm-6">
                            <div class="product-images">
                                <div class="product-main-img">
                                    <!-- Como o produto será enviado dinamicamente pela seleção do usuário, 
                                    alteramos a rotina estática para acesso a imagem para os dados do objeto product
                                    <img src="/resource/site/img/product-2.jpg">
                                    -->
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <div class="product-inner-price">
                                    <!-- Como o produto será enviado dinamicamente pela seleção do usuário, 
                                    alteramos a rotina estática para exibição do preço para os dados do objeto product
                                    <ins>$700.00</ins>
                                    -->
                                ...
                                <div class="product-inner-category">
                                    <!-- Como o produto será enviado dinamicamente pela seleção do usuário, 
                                    alteramos a rotina estática para exibição de categorias para os dados do 
                                    objeto product
