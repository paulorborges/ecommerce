...
<section class="content">
    ...
    <div class="row">
        <!-- Tela foi dividida em duas colunas col-md-6-->
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <!-- Do lado esquerdo, vai exibir os produtos não relacionados -->
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <!-- Do lado direito, vai exibir os produtos relacionados com a categoria -->
