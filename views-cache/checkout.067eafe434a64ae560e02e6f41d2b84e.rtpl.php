									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											<table class="shop_table">
												...
												<tbody>
													<!-- Para automatizar o carrinho de compras, podemos criar um loop do raintpl -->
													<?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?>

														<tr class="cart_item">
															<td class="product-name">
																<!-- Preencheremos o nome do produto em substituição ao método estático
															...
															<td class="product-total">
																<!-- Preencheremos o valor de cada um dos produtos em substituição ao metodo
																estático 
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<!-- Preencheremos o valor do subtotal dos produtos conforme carrinho de compras
														estático 
													...
													<tr class="order-total">
														...
														<!-- Preencheremos o valor do total dos produtos conforme carrinho de compras
														estático 
