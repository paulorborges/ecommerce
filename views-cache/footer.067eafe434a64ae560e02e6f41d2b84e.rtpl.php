            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <!--
                                Como todas as vezes que uma categoria for criada, ou a cada vez que a página for carregada
                                essa informação precisa ser atualizada no banco, isso consumiria muito processador além de
                                muitos acessos ao banco de dados. Dessa forma, para esse tipo de ferramenta, importante 
                                criar um arquivo separado que será escrito dinamicamente a cada alteração no banco. Dessa forma
                                o arquivo ficará estático com atualizações dinamicas

                                A parte abaixo se refere ao modelo inicial, exemplo
                            ...
                            <li><a href="#">Categoria Cinco</a></li>
                                ...
                                Desse ponto em diante, se refere a nova metodologia
                            -->
